...
echo "," >> dashboard/repository_list.json
../.github/scripts/dashboard_update_repo.sh $token eclipse-keyple keypleless-reader-nfcmobile-kmp-lib true false
echo "," >> dashboard/repository_list.json
../.github/scripts/dashboard_update_repo.sh $token eclipse-keyple keypleless-distributed-client-kmp-lib true false
echo "," >> dashboard/repository_list.json
