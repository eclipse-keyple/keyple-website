...
5. Follow the explanations given in the [Build your first app]({{<
   ref "archives/docs-1.0/build-your-first-app" >}}) section to configure your
   environment.
6. Using the [Java components]({{< ref "archives/components-java-1.0/_index.md" >}}) or [C++ components]({{< ref "archives/components-cpp-0.9/_index.md" >}}) pages, import
...
please see the [Java]({{< ref "archives/components-java-1.0/_index.md" >}}) or [C++]({{< ref "archives/components-cpp-0.9/_index.md" >}}) pages.
...
[Javadoc documentation]({{< ref "archives/docs-1.0/api-reference" >}}).
...
* [Keyple Core Java component]({{< ref "/archives/components-java-1.0/core" >}})
* [Keyple Core C++ component]({{< ref "/archives/components-cpp-0.9/core" >}})
