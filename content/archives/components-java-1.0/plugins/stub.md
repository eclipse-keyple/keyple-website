...
[GitHub](https://github.com/eclipse-keyple/keyple-java/tree/master/java/component/keyple-plugin/stub)
...
* <a href="../../../../archives/docs-1.0/api-reference/java-api/keyple-java-plugin-stub/{{% keyple-java-version %}}/index.html">JavaDoc API</a>
