...
Keyple relies on the [Keypop Reader API](https://keypop.org/apis/reader-layer/reader-api/) based on the standard Terminal API specifications proposed by Calypso Networks Association and thus inherits an existing modeling effort.
