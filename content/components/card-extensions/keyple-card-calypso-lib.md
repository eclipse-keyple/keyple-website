...
<tbody>
  ...
  <tr>
    <td>{{< icon name="exchange-alt" pack="fas" >}} {{< external-link url="https://github.com/eclipse-keyple/keyple-card-calypso-cpp-lib/releases/" name="Release History" >}} <strong><sup>1</sup></strong></td>
  ...
  <tr>
    <td>{{< icon name="sitemap" pack="fas" >}} {{< external-link url="https://docs.keyple.org/keyple-card-calypso-uml-lib/" name="UML Class Diagram" >}} <strong><sup>1</sup></strong></td>
